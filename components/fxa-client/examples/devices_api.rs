...
fn load_fxa_creds() -> Result<FirefoxAccount, anyhow::Error> {
...
fn load_or_create_fxa_creds(cfg: Config) -> Result<FirefoxAccount, anyhow::Error> {
...
fn create_fxa_creds(cfg: Config) -> Result<FirefoxAccount, anyhow::Error> {
